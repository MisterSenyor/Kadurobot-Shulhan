...
PLAYERS_RANGES = [
    (0, MOVEMENT_RANGE_MM),
    (DISTANCE_BETWEEN_PLAYERS_MM, DISTANCE_BETWEEN_PLAYERS_MM + MOVEMENT_RANGE_MM),
    (2 * DISTANCE_BETWEEN_PLAYERS_MM, 2 * DISTANCE_BETWEEN_PLAYERS_MM + MOVEMENT_RANGE_MM),
]
